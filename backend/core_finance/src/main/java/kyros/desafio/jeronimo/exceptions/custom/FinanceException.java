package kyros.desafio.jeronimo.exceptions.custom;

import java.io.Serializable;
import java.text.MessageFormat;
import java.util.ResourceBundle;

public class FinanceException extends Exception implements Serializable {
    ...
    public FinanceException(String code, Object... params) {
        setCode(code);
